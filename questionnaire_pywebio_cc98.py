'''
FilePath: questionnaire_pywebio copy.py
Author: zjushine
Date: 2023-04-09 17:55:18
LastEditors: zjushine
LastEditTime: 2023-04-11 20:31:00
...
def survey():
    ...
    # 显示感谢信息
    put_markdown("# 感谢您的参与！")
    put_text("以下是1元奖励，请您进入链接领取，谢谢")
    put_text("https://www.wenjuan.com/s/UZBZJv2V7OA/#《问卷标题》，快来参与吧。【问卷网提供支持】")

if __name__ == '__main__':
    start_server(survey, port=8000,debug=True)